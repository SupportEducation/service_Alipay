...
/**
 * Servlet implementation class Or_AddOrganizationServlet
 */
@WebServlet("/OrganizationWeb/Or_AddOrganizationServlet")
public class Or_AddOrganizationServlet extends HttpServlet {
     ...
     */
    public Or_AddOrganizationServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     //  String uploadPath=s1.getRealPath("/")+ UPLOAD_DIRECTORY;
      ...
      //将信息存入 数据库
		...
		or.setOr_user(request.getSession().getAttribute("oname").toString());
      ...
      //上传完毕后  转发到首页
        request.getServletContext().getRequestDispatcher("/OrganizationWeb/Or_business.jsp").forward(
                request, response);
        out.flush();
		out.close();
	}
