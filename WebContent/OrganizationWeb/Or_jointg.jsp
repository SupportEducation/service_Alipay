	...
	<div class="main">
		<div class="navbar">
			...
			<div class="menu">
				...
				<a href="Or_jointg.jsp" class="menu-item2" style="color: #69e;">审核通过</a>
		...
		<div class="main-r">
			<div class="main-search">
				<p>全部职位</p>
				<form class="search">
					<input type="text" placeholder="请输入职位名称或者ID">
				...
				<table class="main-table">
					...
					<tr>
						...
						<td>
							...
							<a href="Or_ExamineVoluteer?flat=2&&vid=<%=vo.getVid()%>&&page=Or_jointg">退回</a>
						</td>
					</tr>
						<%}} %>
				</table>
