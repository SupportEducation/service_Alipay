				...
				<div class="layui-main">
					<div class="admin-login-box">
						<a class="logo" style="left: 0;" href="index.html">
							<span style="font-size: 22px;">系统管理平台</span>
						</a>
						<div class="admin-side-toggle">
							<i style="margin-top: 10px" class="fa fa-bars" aria-hidden="true"></i>
						</div>
						<div class="admin-side-full">
							<i style="margin-top: 10px" class="fa fa-life-bouy" aria-hidden="true"></i>
						</div>
					</div>
